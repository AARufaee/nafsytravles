...
// Ported verbatim from src/components/earth-texture.ts.
export function createEarthTexture() {
  ...
  ocean.addColorStop(0, "#1c3480");
  ocean.addColorStop(1, "#0d1640");
  ctx.fillStyle = ocean;
  ctx.fillRect(0, 0, width, height);

  ctx.strokeStyle = "rgba(127, 220, 255, 0.16)";
  ctx.lineWidth = 1;
  ...
  function landmass(lon, lat, rx, ry, alpha = 0.95) {
  ...
  landmass(-88, 18, 22, 12, 0.85); // Central America
  ...
  landmass(112, 12, 32, 18, 0.85); // SE Asia
